...
import { OracleResponse, OldGod, CardInstance } from '@/core/types';
...
export default function OraclePage() {
  ...
  const [gods, setGods] = useState<OldGod[]>([]);
  const [selectedGod, setSelectedGod] = useState<OldGod | null>(null);
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (godsRes.ok) {
          ...
          if (urlGodId) {
            setGodId(urlGodId);
            const god = godsData.find((g: OldGod) => g.id === urlGodId);
